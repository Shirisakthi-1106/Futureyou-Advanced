...
export default function Home() {
    const { user, setIsAuthOpen, habits, setHabits, setPredictions, setChatHistory } = useContext(AppContext);
    ...
    return (
        ...
        >
            ...
            <div className="glass-panel rounded-[2rem] p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative overflow-hidden z-10">
